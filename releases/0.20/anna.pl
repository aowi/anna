...
# Version 0.20. Copyright (C) 2006 Anders Ossowicki <and@vmn.dk>
...
$script{'version'} = "0.20";
$script{'release_date'} = "Sat Sep  2 21:43:07 CEST 2006";
...
## on_notice
# This is for notices... or something
sub on_notice {
	my ($self, $event) = @_;
